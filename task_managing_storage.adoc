...
要了解有关 FlexClone 卷的详细信息，请参见 http://["《 ONTAP 9 逻辑存储管理指南》"^]。
...
+
有关详细信息，请参见 link:task_replicating_data.html#replicating-data-between-systems["在系统之间复制数据"]。
...
. 配置卷以进行数据访问。
+
有关为数据访问配置目标卷的信息，请参见 http://["《 ONTAP 9 卷灾难恢复快速指南》"^]。
